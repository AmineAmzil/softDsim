    ...
    <HStack backgroundColor="white" borderRadius="2xl" p={5} spacing={15} mb={5} w="full">
      ...
      <VStack minW="200px" alignItems="baseline">
        ...
        <Stat>
          ...
          <StatNumber>{firstIteration && tasksBug === 0 ? "?" : tasksBug}</StatNumber>
          <StatHelpText>
            <StatArrow type="increase" />
            {tasksBug - tasksBugBefore} since last iteration
          </StatHelpText>
          <StatHelpText>* Bugs are noticed as soon as you do unit tests</StatHelpText>
        </Stat>
      </VStack>
    </HStack>
  );
